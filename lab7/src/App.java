...
public class App
{
    public static void main(String[] args)
    {
        ...
        {
            @Override
            public @Nullable Book findBookByTitle(
                    @NotNull ArrayList<Book> books, String bookTitle)
            {
                for (Book book : books) {
            ...
            @Override
            public @Nullable Book findBookByAuthor(
                    @NotNull ArrayList<Book> books, String bookAuthor)
            {
                for (Book book : books) {
            ...
            @Override
            public void lendBooks(@NotNull ArrayList<Book> books, Reader reader)
            {
            ...
            @Override
            public void overdueNotify(@NotNull ArrayList<Book> books, Reader reader)
            {
        ...
        {
            @Override
            public boolean takeBooks(@NotNull ArrayList<Book> books, Administrator admin)
            {
            ...
            @Override
            public boolean returnBook(@NotNull ArrayList<Book> books, Administrator admin)
            {
